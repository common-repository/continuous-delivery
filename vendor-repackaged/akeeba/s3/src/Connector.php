...
namespace Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4;

// Protection against direct access
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotDeleteFile;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotGetBucket;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotGetFile;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotListBuckets;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotOpenFileForWrite;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Exception\CannotPutFile;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Akeeba\Engine\Postproc\Connector\S3v4\Response\Error;
