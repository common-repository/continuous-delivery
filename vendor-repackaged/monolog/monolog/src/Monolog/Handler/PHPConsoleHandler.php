...
use Exception;
use Dreitier\WordPress\ContinuousDelivery\Vendor\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Dreitier\WordPress\ContinuousDelivery\Vendor\Monolog\Logger('all', array(new \Dreitier\WordPress\ContinuousDelivery\Vendor\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Dreitier\\WordPress\\ContinuousDelivery\\Vendor\\Monolog\\'), // array Hide calls of classes started with...
