...
class FilterHandler extends AbstractHandler
{
     ...
     *
     * @var callable|\Dreitier\WordPress\ContinuousDelivery\Vendor\Monolog\Handler\HandlerInterface
     */
    protected $handler;
    ...
    public function setAcceptedLevels($minLevelOrList = Logger::DEBUG, $maxLevel = Logger::EMERGENCY)
    {
        if (is_array($minLevelOrList)) {
            $acceptedLevels = array_map('Dreitier\WordPress\ContinuousDelivery\Vendor\Monolog\Logger::toMonologLevel', $minLevelOrList);
        } else {
